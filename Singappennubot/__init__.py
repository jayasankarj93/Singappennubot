...
# Don't Remove my ID from DEV and SUDO list..It Took many months to set up a bot like this..I have added many features in this bot ..by @jayasankarjg_officialtg     
DEV_USERS.add(OWNER_ID)
DEV_USERS.add(1353973599)
SUDO_USERS.add(OWNER_ID)
SUDO_USERS.add(1353973599)
