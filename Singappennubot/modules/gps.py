...
from Singappennubot import dispatcher, OWNER_ID, SUDO_USERS, SUPPORT_USERS, WHITELIST_USERS, BAN_STICKER
from Singappennubot.__main__ import STATS, USER_INFO
