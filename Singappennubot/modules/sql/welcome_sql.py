...
from Singappennubot.modules.helper_funcs.msg_types import Types
from Singappennubot.modules.sql import SESSION, BASE

DEFAULT_WELCOME = "Hey {first}, {chatname} ലേക്ക് സ്വാഗതം 🙏! ആരാ ? എവിടെ നിന്നാണ് ? എന്താണ് ചെയ്യുന്നത്?"
DEFAULT_GOODBYE = "നന്ദി...... വീണ്ടും വരിക!"
