...
from Singappennubot.modules.helper_funcs.chat_status import bot_admin, can_promote, user_admin, can_pin, dev_plus
...
def do(func, bot, update):
    ...
    os.chdir(os.getcwd())
    with open('%s/Singappennubot/modules/helper_funcs/temp.txt' % os.getcwd(), 'w') as temp:
        temp.write(body)
