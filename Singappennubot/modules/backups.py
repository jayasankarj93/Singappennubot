...
import Singappennubot.modules.sql.notes_sql as sql
from Singappennubot import dispatcher, LOGGER, OWNER_ID, SUDO_USERS, MESSAGE_DUMP
from Singappennubot.__main__ import DATA_IMPORT
from Singappennubot.modules.helper_funcs.chat_status import user_admin
from Singappennubot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from Singappennubot.modules.helper_funcs.msg_types import get_note_type
from Singappennubot.modules.rules import get_rules
import Singappennubot.modules.sql.rules_sql as rulessql
from Singappennubot.modules.sql import warns_sql as warnssql
import Singappennubot.modules.sql.blacklist_sql as blacklistsql
from Singappennubot.modules.sql import disable_sql as disabledsql
from Singappennubot.modules.sql import cust_filters_sql as filtersql
import Singappennubot.modules.sql.welcome_sql as welcsql
import Singappennubot.modules.sql.locks_sql as locksql
from Singappennubot.modules.connection import connected
...
def export_data(bot: Bot, update: Update, chat_data):
    ...
    f=open("Singappennubot{}.backup".format(chat_id), "w")
    ...
    try:
        ...
        pass
    bot.sendDocument(current_chat_id, document=open('Singappennubot{}.backup'.format(chat_id), 'rb'), caption="*Successfully imported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This  is specially made for notes.".format(chat.title, chat_id, tgl), timeout=360, reply_to_message_id=msg.message_id, parse_mode=ParseMode.MARKDOWN)
    os.remove("Singappennubot{}.backup".format(chat_id)) # Cleaning file
