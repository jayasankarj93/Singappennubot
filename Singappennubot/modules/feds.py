...
from Singappennubot import dispatcher, OWNER_ID, SUDO_USERS, DEV_USERS, WHITELIST_USERS, LOGGER, MESSAGE_DUMP
from Singappennubot.modules.helper_funcs.handlers import CMD_STARTERS
from Singappennubot.modules.helper_funcs.misc import is_module_loaded, send_to_list
from Singappennubot.modules.helper_funcs.chat_status import is_user_admin
from Singappennubot.modules.helper_funcs.extraction import extract_user, extract_unt_fedban, extract_user_fban
from Singappennubot.modules.helper_funcs.string_handling import markdown_parser
from Singappennubot.modules.disable import DisableAbleCommandHandler

import Singappennubot.modules.sql.feds_sql as sql

from Singappennubot.modules.connection import connected
from Singappennubot.modules.helper_funcs.alternate import send_message
    ...
    if args:
        if args[0] == 'json':
            ...
            with BytesIO(str.encode(backups)) as output:
                output.name = "Singappennubot_fbanned_users.json"
                update.effective_message.reply_document(document=output, filename="Singappennubot_fbanned_users.json",
            ...
            for users in getfban:
                ...
                backups += "\n"
            with BytesIO(str.encode(backups)) as output:
                output.name = "Singappennubot_fbanned_users.csv"
                update.effective_message.reply_document(document=output, filename="Singappennubot_fbanned_users.csv",
