...
from Singappennubot import dispatcher, LOGGER
...
from Singappennubot.modules.helper_funcs.extraction import extract_text
from Singappennubot.modules.helper_funcs.filters import CustomFilters
from Singappennubot.modules.helper_funcs.misc import build_keyboard
from Singappennubot.modules.helper_funcs.string_handling import split_quotes, button_markdown_parser
from Singappennubot.modules.sql import cust_filters_sql as sql
                ...
                try:
                    ...
                    if excp.message == "Unsupported url protocol":
                        message.reply_text("You seem to be trying to use an unsupported url protocol. Telegram "
                                           ...
                                           "again, or ask in @jayasankarjg_officialtg for help.")
                        ...
                        message.reply_text("This note could not be sent, as it is incorrectly formatted. Ask in "
                                           "@jayasankarjg_officialtg if you can't figure out why!")
