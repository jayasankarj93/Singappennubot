...
from Singappennubot import dispatcher, WHITELIST_USERS, SUPPORT_USERS, SUDO_USERS, DEV_USERS, OWNER_ID
from Singappennubot.modules.helper_funcs.chat_status import whitelist_plus, dev_plus
...
ELEVATED_USERS_FILE = os.path.join(os.getcwd(), 'Singappennubot/elevated_users.json')
