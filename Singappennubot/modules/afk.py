...
from Singappennubot.modules.sql import afk_sql as sql
from Singappennubot.modules.users import get_user_id
...
__help__ = """
 - /afk <reason>: mark yourself as AFK(ഇനി എല്ലാവർക്കും ഷോർട്ട് ബ്രേക്ക്.).
