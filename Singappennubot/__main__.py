...
from Singappennubot import dispatcher, updater, TOKEN, WEBHOOK, SUDO_USERS, OWNER_ID, CERT_PATH, PORT, URL, LOGGER, OWNER_NAME, ALLOW_EXCL
from Singappennubot.modules import ALL_MODULES
from Singappennubot.modules.helper_funcs.chat_status import is_user_admin
from Singappennubot.modules.helper_funcs.misc import paginate_modules
from Singappennubot.modules.connection import connected
from Singappennubot.modules.connection import connect_button
...
SOURCE_STRING = """
⚡I'm built in python3, using the python-telegram-bot library, and am fully opensource - you can find what makes me tick [here](https://github.com/jayasankarj93/Singappennubot)
⚡You Can Clone Me [Here](https://heroku.com/deploy?template=https://github.com/jayasankarj93/Singappennubot.git)
"""
...
if START_IMG is None:
    img = "https://telegra.ph/file/ea0e098341eb29314eb70.jpg"
else:
  img = START_IMG    
    
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Singappennubot.modules." + module_name)
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="🤝Help",callback_data="help_back"),InlineKeyboardButton(text="🛡Creator🛡",url="https://t.me/jayasankarjg_officialtg")]]
...
def get_help(bot: Bot, update: Update):
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="⚜️Help",url="t.me/{}?start=help".format(bot.username))],  
                                                [InlineKeyboardButton(text="🛡Contact Creator",url="https://t.me/jayasankarjg_officialtg")]]))
        return
...
def main():
    ...
    if WEBHOOK:
        ...
        LOGGER.info("Singappennubot running...")
